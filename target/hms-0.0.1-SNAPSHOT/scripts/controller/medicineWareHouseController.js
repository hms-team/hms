 ...
 */
var medicineAmtModule = angular.module("medicineWareHouseModule",[]);
medicineAmtModule.controller("medicineWareHouseController",function ($scope, $http) {
    ...
    $scope.expToStoreHouse = function (medAmt,storeAmt) {
        ...
        var temp = parseInt(medAmt.amountWarehouse) - parseInt(storeAmt);
        if(temp < 0){
            alert("药库量不足！");
            return;
        }
